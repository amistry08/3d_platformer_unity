...
public class GameManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (player == null)
        {
            ThirdPersonCharacterController thirdPersonCharacterController = FindFirstObjectByType<ThirdPersonCharacterController>();
    ...
    public static void ResetGearParts()
    {
        gearParts = 0;
    }
    ...
    public static void AddGearParts(int gear)
    {
        gearParts += gear;
        if (gearParts == 5) 
        {
            PlayerPrefs.SetInt("Flag_HasAllParts", 1);
        }
    }
    ...
    public void InitilizaGameProgressPreps()
    {
        PlayerPrefs.SetInt("Flag_HasBaseKey", 0);
        PlayerPrefs.SetInt("Flag_HasAllParts", 0);
        PlayerPrefs.SetInt("Flag_ShowParts", 0);
